...
for i in "${!DATA_PATHS[@]}"; do
    ...
    for BUILD_RATIO in "${BUILD_RATIOS[@]}"; do
        ...
        BUILD_RATIO_LOG="100K_build_$BUILD_RATIO"
        ...
        #    echo "Starting experiment with partition size $PARTITION_SIZE..." > $LOG_FILE
            ...
            sed -i "s/maxNodesPerPartition = [0-9]\+/maxNodesPerPartition = $PARTITION_SIZE/" $SOURCE_BUILD_FILE
    ...
    #            POOL_RATIO_LOG="pool_static_$POOL_RATIO"
                ...
                LOG_FILE="/home/jaewonoh/workspace/ann-benchmark/jaewon-test/insert/${LOG_NAME}_${BUILD_RATIO_LOG}_${PARTITION_LOG}_${POOL_RATIO_LOG}.log"
...
#                fi
                ...
                echo "Starting experiment with Build Ratio=${BUILD_RATIO}%, Pool Ratio=${POOL_RATIO_LOG}, PARTITION SIZE=${PARTITION_SIZE} ..." > $LOG_FILE
#    #
