...
LOG_FILE="/home/jaewonoh/workspace/ann-benchmark/jaewon-test/final/5_visit_node.log"
...
for i in "${!DATA_PATHS[@]}"; do
    ...
    LOG_FILE_COUNT="/home/jaewonoh/workspace/ann-benchmark/jaewon-test/final/5_visit_node_${DATA_NAME}.log"
